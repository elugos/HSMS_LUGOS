...
def process_file(
    ...
    # --- DEDUPE: keep longest RELATION per SUBJECT ---
    triples_df = dedupe_relation_longest_object(
        triples_df,
        subject_col="subject",
...
def main():
    ...
    ap.add_argument("--text-col", default="text", help="Name of the text column in input CSVs (default: text).")
